...
// SVG icon component for the "views" count.
...
// SVG icon component for the "likes" count.
...
export default function PostCard({ post, priority = false }: { post: Post; priority?: boolean; }) {
    ...
    // Handles the client-side logic for liking/unliking a post.
    ...
    // GSAP animation for hover effects on the card.
    useGSAP(() => {
        ...
        tl.to(image, { scale: 1.05 })
          .to(arrow, { x: 5, color: '#f99d32' }, 0); // The '0' at the end makes this animation run in parallel with the previous one.
                    ...
                    <div className="mt-6 pt-4 border-t border-gray-100 flex justify-between items-center text-gray-500">
                        ...
                        <div className="flex items-center gap-4">
                            <div className="flex items-center gap-1">
                                ...
                                {/* Format the view count to be more readable (e.g., 1.2k). */}
